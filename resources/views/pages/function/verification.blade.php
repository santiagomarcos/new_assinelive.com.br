        ...
        <div class="form-contract-content">
            <div class="form-contract-header">
                <div class="icon-checkout">
                    ...
                    <span class="icon-form"><i class="fas fa-list-alt"></i></span>

                    <span class="conection-icon"></span>

                    <span class="icon-confirm "><i class="fas fa-check"></i></span>

                    <p class="title-icon-form">Formulário</p>
                    <p class="title-icon-confirm title-active">Confirmação</p>
