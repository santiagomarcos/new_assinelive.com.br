                ...
                <div class="items-plan-box">
                    ...
                    <div class="items-plan-body">
                        ...
                        <ul class="content-items-include">
                            <li class="items-include-plan">+1 canais online</li>
                            <li class="items-include-plan">Modem de wi-fi</li>
                            <li class="items-include-plan"><strong>20 MB</strong> de upload</li>
                            <li class="items-include-plan">voz fixa limitada local</li>
                        </ul>
            ...
            <div class="items-plan-content">
                <div class="items-plan-box">
                    ...
                    <div class="items-plan-body">
                        ...
                        <ul class="content-items-include">
                            <li class="items-include-plan">+12 canais online</li>
                            <li class="items-include-plan">Modem de wi-fi</li>
                            <li class="items-include-plan"><strong>30 MB</strong> de upload</li>
                            <li class="items-include-plan">voz fixa limitada local</li>
                        </ul>
                        <div class="content-price">
                            <div class="begin-in">A partir de:</div>
            ...
            <div class="items-plan-content">
                <div class="items-plan-box">
                    ...
                    <div class="items-plan-body">
                        ...
                        <ul class="content-items-include">
                            <li class="items-include-plan">+2 canais online</li>
                            <li class="items-include-plan">Modem de wi-fi</li>
                            <li class="items-include-plan"><strong>60 MB</strong> de upload</li>
                            <li class="items-include-plan">voz fixa limitada local</li>
                        </ul>
                        <div class="content-price">
                            <div class="begin-in">A partir de:</div>
