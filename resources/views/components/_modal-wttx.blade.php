<div class="modal" id="wttx" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content wttx-content">
            <div class="modal-header header-wttx">
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
                <div class="modal-title">
                    <h1 class="first-title-modal title-wttx">Temos uma ótima opção para as regiões que ainda não possuem cobertura da Utra internet</h1>
                    <h2 class="second-title-modal title-wttx">Escolha o plano que mais se indentifica com você cliente TIM.</h2>
                </div>
            </div>
            <div class="modal-body">
                <div class="container-carousel">
                    <div class="content-carousel">
                        <div id="owl_wttx" class="owl-carousel">
                            {{--Wttx items--}}
